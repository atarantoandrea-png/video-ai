...
> ⚠️ **Le riflessioni sono il "cervello" di Elisa, non frasi da social.** Attingi SEMPRE dalla **conoscenza
...
## I 5 HOOK — un angolo diverso ciascuno

Scrivi **5 hook brevi** (≤ ~12 parole, prima riga del post), **uno per angolo**, così l'utente sceglie.
Ognuno deve reggere da solo come frase che **ferma lo scroll**. **Adatta sempre** al video reale (gli esempi
sotto sono solo lo stile).

1. **Emotivo forte** — dritto al cuore, emozione cruda (commozione, dolore, amore che resta).
   *Es: «"Mamma, ora sto bene": e finalmente ha ripreso a respirare.»*
2. **Curiosità grande** — apre un loop e **non rivela**: costringe a guardare per sapere.
   *Es: «Quello che è arrivato in questo consulto non me lo aspettavo.»*
3. **Strappalacrime** — tenera, fa venire le lacrime; spesso una frase del defunto o un dettaglio intimo.
   *Es: «Le ultime parole che aspettava da mesi sono arrivate oggi.»*
...
## RIFLESSIONE 1 — la DESCRIZIONE (nel post): CON keyword, profonda ma PIÙ CORTA

Una riflessione **breve** (2-3 righe) e **densa**, presa dal pensiero di Elisa, **con le keyword classiche**
intessute con naturalezza (per la SEO/ricerca) — **mai keyword-stuffing**.

**Schema:** apri spesso con *«Ecco cosa succede quando…»* o *«Il mio punto di vista come medium…»* → 1-2
...
testo e/o negli **hashtag** (4-8, i primi branded: `#ElisaSoulMedium #medium #aldilà #lutto #spiritualità`).
**Mai forzare** keyword non attinenti.
