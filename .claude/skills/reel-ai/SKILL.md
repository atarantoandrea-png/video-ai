...
description: >-
  ...
  individua l'hook e i tagli usando la tecnica dell'open-loop e la mappa dei contesti,
  itera con l'utente sul "carosello" dei segmenti scelti, e produce un «Reel Build Brief»
  da incollare nell'AI in-app dell'editor video (sezione AI). Usare quando l'utente vuole
  ricavare un reel verticale (9:16) da un video lungo, un'intervista o un podcast.
  Invocazione: /reel-ai
---
...
5. **Costruisci il reel attorno a UN discorso forte:** apertura che crea curiosità/emozione + sviluppo che **arriva a una chiusura sensata**. Con più interlocutori, **includi le risposte** (es. la domanda di uno + la risposta dell'altro). Il discorso NON deve restare a metà.
...
Chiudi spiegando **come usarlo**: *"Copia tutto il brief qui sopra e incollalo nel pannello **AI** dell'app dell'editor, poi premi «Costruisci reel». L'AI in-app monterà il reel sulla timeline e ti farà alcune domande (es. se sfocare qualcuno)."*
